...
**Status:** **COMPLETE — P4 EXIT 2026-07-21.** W0–W3 are merged (PRs #117–#119, #123, and #166); W4's three biting eval suites and all P4-scoped gates passed at candidate `71cd249ddf0f9b0526575082d5646473df3ac0ca` in CI run `29838591933`. See `P4-RELEASE-READINESS.md`. Entry condition was satisfied by **P3-Platform COMPLETE** (`docs/roadmap/P3-RELEASE-READINESS.md` — all five §11 gates PASS; ADRs 0042–0047 Accepted, 0048 Rejected).
...
| **W4 — evals + phase exit** | **Complete** | Candidate `71cd249d`, run `29838591933`: all required jobs and `all-gates` green; T1/T2/T3 revalidated at one code HEAD. The docs-only T4 closeout is the eighth/final branch commit and does not trigger regular CI. |
...
passed simultaneously at CI-evidenced candidate HEAD `71cd249d` in run
`29838591933` (the docs-only T4 closeout commit does not trigger regular CI) —
