...
Codex is the implementation authority — it owns design, architecture,
...
`.claude/workflows/README.md` — read them before launching a workflow; the
`.codex/agents/*.toml` roles mirror those definitions. Standing discipline
derived from prior milestones:
